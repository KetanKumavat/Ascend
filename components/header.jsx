...
const Header = async () => {
    ...
    return (
        <header className="flex justify-between items-center left-1/2 -translate-x-1/2 p-4 gap-3 bg-neutral-400 fixed top-2 w-[min(768px,100%_-_2rem)] min-w-fit rounded-full bg-opacity-15 backdrop-blur-md shadow-lg border-white border border-opacity-10 z-50">
