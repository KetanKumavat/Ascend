...
export function TranscriptViewer({ meetingId, meeting }) {
    ...
    const handleDownloadTranscript = () => {
        ...
        a.href = url;
        a.download = `${meeting.title}-transcript-${format(
            ...
            <Card>
                <CardContent className="flex flex-col items-center justify-center py-12">
                    ...
                    <p className="text-muted-foreground text-center">
                        The transcript for this meeting is not yet available. It
                        will be generated automatically after the meeting ends.
                    </p>
                </CardContent>
            </Card>
        );
    ...
    const highlightSections = transcript.highlights
        ? formatHighlights(transcript.highlights)
        : [];
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                        Generated on{" "}
                        {format(new Date(transcript.createdAt), "PPP 'at' p")}
                    </p>
                </div>
                <div className="flex items-center gap-2">
                    <Button
                        ...
                        size="sm"
                        onClick={() =>
                            handleCopyToClipboard(transcript.content)
                        }
                    >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="border-t pt-4 mt-4">
                                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                                            ...
                                            may not capture all details. Review
                                            the full transcript for complete
                                            information.
                                        </div>
                                    </div>
                                </div>
