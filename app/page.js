...
const Home = () => {
    return (
        ...
        `}</style> */}
            ...
            <section
                className="relative py-20 w-full mx-auto text-center z-0"
                id="how-it-works"
            >
            ...
            <section className="py-20 w-full mx-auto text-center px-5 z-50">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-lg md:text-xl text-neutral-300 mb-12 cursor-default">
                        Join thousands of teams already using Ascend to
