  ...
  return (
    <BackgroundBeamsWithCollision className="w-full min-h-screen relative z-10 flex items-center justify-center bg-white">
      ...
      <main className="flex flex-col items-center text-center max-w-3xl p-6 rounded-lg relative z-20">
        <h1 className="text-6xl md:text-9xl font-extrabold pb-4 text-transparent bg-clip-text bg-gradient-to-b from-lime-200 via-lime-500 to-lime-700">
          Ascend
        </h1>
        <p className="text-xl md:text-3xl font-normal text-gray-200 pb-8">
