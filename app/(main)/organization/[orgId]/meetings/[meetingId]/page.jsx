...
import { ArrowLeftIcon, VideoIcon, CalendarIcon, ClockIcon, UsersIcon, PlayIcon } from "lucide-react";
...
export default async function MeetingDetailPage({ params }) {
  ...
  const canJoin = getMeetingStatus(meeting) === "upcoming" || getMeetingStatus(meeting) === "in-progress";
  const showTranscript = getMeetingStatus(meeting) === "ended" || getMeetingStatus(meeting) === "completed";
    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium">
                    {format(new Date(meeting.scheduledAt), "EEEE, MMMM do, yyyy")}
                  </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium">{meeting.duration || 60} minutes</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium">{meeting.participants?.length || 0} participants</p>
              ...
              <div className="pt-2 border-t">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">{meeting.createdBy.name || meeting.createdBy.email}</span>
                </div>
              </div>
            </CardContent>
          </Card>
                  ...
                  {meeting.participants.map((participant) => (
                    <div key={participant.id} className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <p className="font-medium">{participant.user.name || participant.user.email}</p>
        ...
        <div className="lg:col-span-2">
          {showTranscript ? (
            <TranscriptViewer meetingId={meeting.id} meeting={meeting} />
          ) : (
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-16">
                <VideoIcon className="w-16 h-16 text-muted-foreground mb-4" />
                <h3 className="text-xl font-semibold mb-2">
                  {getMeetingStatus(meeting) === "upcoming" ? "Meeting hasn't started yet" : "Meeting in progress"}
                </h3>
